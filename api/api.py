...
api_blueprint.route("/refresh_token", methods=["POST"])(
...
api_blueprint.route("/bookmark/<int:kacamata_id>", methods=["DELETE"])(
    jwt_required()(delete_bookmark)
)
api_blueprint.route("/users/ubah_password", methods=["POST"])(
    jwt_required()(ubah_password)
)
api_blueprint.route("/users/sendotp_sandi", methods=["POST"])(send_otp_sandi)
api_blueprint.route("/users/reset_password", methods=["POST"])(lupa_password)
