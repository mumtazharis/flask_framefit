...
# api_blueprint.route('/users', methods=['GET'])(get_users)
# api_blueprint.route('/users', methods=['POST'])(add_user)
# api_blueprint.route('/users/login', methods=['POST'])(login_user)
# api_blueprint.route('/users/<int:user_id>/profile', methods=['GET'])(get_profile)
# api_blueprint.route('/contact', methods=['POST'])(contact_admin)
# api_blueprint.route('/kacamata', methods=['GET'])(get_kacamata)
# api_blueprint.route('/kacamata', methods=['POST'])(add_kacamata)
